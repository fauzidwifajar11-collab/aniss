...
`).join('');
    ...
    prepareCompleteSettings(settingsToUse) {
        ...
        const completeSettings = {
            ...
            sequence: settingsToUse.sequence || 'HAPPY|BIRTHDAY|MY|CUTEE|LITTLE|ANIS|❤',
    ...
    getCurrentSettingsFromModal() {
        ...
        try {
            ...
            const modalSettings = {
                ...
                sequence: document.getElementById('sequenceText')?.value || 'HAPPY|BIRTHDAY|MY|CUTEE|LITTLE|ANIS|❤',
